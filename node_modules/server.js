...
const secure = require('secure-headers');
...
function start(route, handle) {
	function onRequest(req,res){
		var securedResponseObject = secure.headers(res, req)	
		//Parse path
		var pathname = url.parse(req.url).pathname;
		console.log("Request for "+pathname+" recieved.");
		//Route request based on path
		route(handle, pathname, securedResponseObject, req);
	}

	const certdir = "www.connorfindlay.com";
